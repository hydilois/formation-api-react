...
class Customer
{
     ...
     * @Groups({"customers_read", "invoices_read"})
     * @Assert\NotBlank(message="Le prénom du customer doit être obligatoire")
     ...
     * @ORM\Column(type="string", length=255)
     * @Groups({"customers_read", "invoices_read"})
     * @Assert\NotBlank(message="Le nom de famille du customer doit être obligatoire")
     ...
     * @ORM\Column(type="string", length=255)
     * @Groups({"customers_read", "invoices_read"})
     * @Assert\NotBlank(message="Le prenom du customer doit être obligatoire")
    ...
    /**
     * Recuperer le montant total non payé
     * @Groups({"customers_read"})
     * @return float
     */
